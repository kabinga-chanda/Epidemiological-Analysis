---
title: "Oswego Foodborne Outbreak, 1940"
subtitle: "Analysis of Gastrointestinal Illness Following a Church Supper"
author: 
  - name: Kabinga Chanda
    url: https://zm.linkedin.com/in/kabinga-chanda-7646b1211
    affiliations:
      - name: Core-Data
        city: Zambia
abstract: |
...
keywords: [Epidemiology, Foodborne Illness, Oswego Outbreak]
---
...
## Background
On 19 April 1940, a local health officer in Lycoming, Oswego County, New York, reported an outbreak of acute gastrointestinal illness. An epidemiologist-in-training was assigned to investigate. Preliminary information indicated that all reported cases had attended a church supper held on 18 April, while non-attendees were not affected. The supper took place in the church basement, where food contributed by congregation members was served over several hours. Illness was characterized by acute gastrointestinal symptoms, with rapid recovery and no reported fever.
...
## Results
Of the 80 individuals who attended the church supper, 75 were interviewed, and 46 (61%) reported gastrointestinal illness. Common symptoms included nausea, vomiting, diarrhoea, and abdominal pain, with illness duration of 24–30 hours. No cases reported fever. Onset of symptoms was acute, occurring within hours after the meal. Analysis of food-specific attack rates identified one food item with a substantially higher attack rate among cases compared to non-cases.
...
After adjusting for potential confounders, [food item] remained significantly associated with illness (AOR = [value], 95% CI: [range], p < 0.001).
